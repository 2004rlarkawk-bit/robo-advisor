    ...
    <div className="form-card shipper-workspace-form">
      ...
      <details className="form-section" open>
        ...
        <div className="form-grid">
          <div className="form-group" data-field="companyName"><label className="form-label">회사명(상호명)</label><input className="form-input" value={profile.companyName} onChange={(event) => onProfilePatch({ companyName: event.target.value })} placeholder="ABC Logistics Co., Ltd." /></div>
        ...
        <div className="shipper-item-list">
          {items.map((item, index) => (
            <div className="shipper-item-card" key={item.id}>
              ...
              <div className="form-grid">
                <div className="form-group" data-field="itemName"><label className="form-label">품명</label><input className="form-input" value={item.itemName} onChange={(e) => updateItem(item.id, 'itemName', e.target.value)} placeholder="Cotton T-Shirts" /></div>
                <div className="form-group" data-field="hsCode"><label className="form-label">HS Code</label><input className="form-input" value={item.hsCode} onChange={(e) => updateItem(item.id, 'hsCode', e.target.value)} placeholder={index === 0 ? 'e.g. 6109.10' : ''} /></div>
