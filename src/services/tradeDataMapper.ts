...
export function tradeProfileToFormData(
  ...
  return {
    ...
    shipment: {
      ...
      ...(profile.methodOfDispatch ? { methodOfDispatch: profile.methodOfDispatch } : {}),
      ...(profile.requestInsurance ? { requestInsurance: true } : {}),
      ...(profile.requestCustomsClearance ? { requestCustomsClearance: true } : {}),
      ...(profile.requestInlandHaulage ? { requestInlandHaulage: true } : {}),
    ...
    packaging: {
      ...
      ...(profile.dangerousGoods ? { dangerousGoods: true } : {}),
      ...(profile.dangerousGoodsDetail ? { dangerousGoodsDetail: profile.dangerousGoodsDetail } : {}),
      ...(profile.temperatureControl ? { temperatureControl: profile.temperatureControl } : {}),
    },
    attachments,
...
export function tradeFormDataToProfile(formData: TradeFormDataV3): TradeProfile {
  ...
  return sanitizeTradeProfile({
    ...
    dangerousGoods: packaging.dangerousGoods ?? false,
    dangerousGoodsDetail: packaging.dangerousGoodsDetail ?? '',
    temperatureControl: packaging.temperatureControl ?? '',
    methodOfDispatch: shipment.methodOfDispatch === 'AIR' ? 'AIR' : 'SEA',
    requestInsurance: shipment.requestInsurance ?? false,
    requestCustomsClearance: shipment.requestCustomsClearance ?? false,
    requestInlandHaulage: shipment.requestInlandHaulage ?? false,
