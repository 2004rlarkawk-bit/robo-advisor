...
/* �묓엳�� �숈븞 �대� 肄섑뀗痢좉� 李뚭렇�ъ�吏� �딄퀬 �섎젮 �섍��꾨줉 �� 怨좎젙 */
.sidebar > * {
  min-width: 228px;
}
...
/* 異붿쿇 移대뱶�� 1.5以� �뺣룄 �꾩썙 �뱀뀡 寃쎄퀎瑜� 遺꾨챸�� �쒕떎 */
...
/* �쒕ぉ �꾨옒 遺��쒕� �몃줈濡� �볦븘 醫뚯륫 �뺣젹 �� 移대뱶 泥レ씤�곸뿉�� �쒕ぉ�� 癒쇱� �쏀엳寃� */
...
.info-card {
  ...
  flex-direction: column;
  gap: 16px;
  align-self: start; /* �댁슜 �믪씠留뚰겮留� 李⑥� �� �몃줈 鍮� 怨듦컙 �쒓굅 */
}
...
/* ===== �쒕퉬�� �뚭컻(About) �쒕뵫 �섏씠吏� ===== */
.about-page {
  /* content-body �⑤뵫(32px)�� �곸뇙�� ��釉붾━�� �ㅽ겕 �쒕뵫�쇰줈 */
  margin: -32px;
...
/* 寃��� �붿빟 移� �� 寃��� �꾨즺쨌�뺤씤 �꾩슂 媛쒖닔瑜� 紐⑸줉 �곷떒�� �� 以꾨줈 �몄텧 */
...
/* �� 二쇱껜 諛쒓툒 ��湲�(�ъ썙��/�멸�/�곴났�뚯쓽��) �� �앹꽦�꾨즺(珥덈줉)�� 援щ텇�섎뒗 以묐┰ ��. 痍⑥냼�� �놁쓬(��湲곗� �대떦�놁쓬 �꾨떂). */
...
/* �댁뒋 �ш컖�� 洹몃９ �ㅻ뜑 (寃��� 蹂댁셿 �덈궡) */
/* �ш컖�� 洹몃９ �ㅻ뜑 �� �댁뒋 移대뱶 �ъ씠�먯꽌 �쒖꽑�� 癒쇱� �용룄濡� 移대뱶蹂대떎 �ш퀬 吏꾪븯寃�. */
.sev-section-header {
  display: flex;
  align-items: center;
  gap: 10px;
...
/* �ㅻⅨ履쎌뿉�� ��씠 �먮씪硫� �щ씪�대뱶 �� �� 濡쒓렇�� 移대뱶媛� �먯뿰�ㅻ읇寃� �쇱そ�쇰줈 諛�由� */
.onboarding-panel {
  width: 0;
  margin-left: 0;
  opacity: 0;
...
/* ============================================================
   寃곌낵 �붾㈃(result-view) v8 �� 嫄곕옒 �쇱씤 쨌 以�鍮꾨룄 �덉뼱濡� 쨌 �쒕쪟 �꾪솴 쨌 �닿껐
   湲곗〈 �뚮쭏 �됱쓣 洹몃�濡� �ъ슜. �щ갚�� �됰꼮��, �쒖쿂�� �� �뺣젹.
   ============================================================ */
...
/* 李⑤떒 �곹깭 �덉뼱濡� �� 100% ���� �닿껐 �좊룄 (�됀룸Ц援щ줈 "�꾩쭅 �쒖텧 遺덇�" 紐낇솗��) */
/* �� 以� 而댄뙥�� 諛곕꼫 �� �꾩씠肄� + �쒕ぉ留�, �몃줈 以묒븰 �뺣젹. 醫뚯슦 �щ갚�� �좎�, �곹븯留� 異뺤냼. */
.rv-hero-blocked {
...
/* 湲� �곹깭 臾멸뎄(��: "EXW 議곌굔 - 留ㅼ닔�� 痢� 泥섎━", "愿��몄궗쨌�좉퀬�� 泥섎━ ��湲�")媛� �섎━吏� �딅룄濡�
   �� 以꾧퉴吏� �먯뿰�ㅻ읇寃� 媛먯떥 �쒖떆�쒕떎. */
...
/* 4) �닿껐�섎㈃ �쒖텧 �� �ㅻ뜑留� �뺣━ (�대� 蹂댁셿 �낅젰�� 湲곗〈 �ㅽ��� �좎�) */
...
/* ============================================================
   �닿껐 �뚰겕�ㅽ럹�댁뒪 v9 �� 臾몄젣 臾멸뎄�� �ш쾶쨌吏꾪븯寃�(�ㅻ뱶�쇱씤),
   洹쇨굅/�쒕쪟紐낆� �묒� �뚯깋 �쒕툕�쇱씤, �≪뀡 踰꾪듉�� �묎퀬 �ш컖�� �됱쑝濡�.
   ("湲��� �붿옍諛붾━ �� �꾧퀎瑜� �몄썙 �덉뿉 �ㅼ뼱�ㅺ쾶")
   ============================================================ */
...
/* �뺤씤 ��ぉ 移대뱶 �� �ш컖�꾨퀎 醫뚯륫 而щ윭 諛� + 由щ뵫 留덉빱(踰덊샇/�꾩씠肄�) + �쒕쪟 移� */
...
/* 由щ뵫 留덉빱 �� 寃쎄퀬: 踰덊샇 �먰삎 諛곗� / �ㅻ쪟: �꾩씠肄� �쇱슫�� �ш컖�� */
.fix-card__marker {
...
/* 寃쎄퀬 移대뱶�� �≪뀡 踰꾪듉�� 二쇱슂 �숈옉�대�濡� �뚮옉(primary) �� 留덉빱쨌移⑸쭔 �곕쾭 �좎� */
...
.gs-tips li::before { content: '�뮕'; position: absolute; left: 0; top: 0; font-size: 13px; }
...
/* ============================================================
   �낅젰 �붾㈃ �ㅻⅨ履� "怨좎튌 ��ぉ" 泥댄겕由ъ뒪�� ��
   寃곌낵�붿엯�� �뺣났 �놁씠 �� �먮━�먯꽌 �꾨� �섏젙�섎룄濡� �ㅻ쪟瑜� �� 踰덉뿉 �섏뿴.
   ============================================================ */
...
details.fixlist-group > summary.fixlist-group-head::after {
  content: '�쇱튂湲�'; font-weight: 600; font-size: 11px; color: var(--text-light);
  border: 1px solid var(--border-color); border-radius: 999px; padding: 1px 8px;
}
details.fixlist-group[open] > summary.fixlist-group-head::after { content: '�묎린'; }
.fixlist-items {
...
/* �⑤꼸�� 醫곸븘 媛�濡� 諛곗튂 �� 踰꾪듉 臾멸뎄媛� 以꾨컮轅덈릺誘�濡� �몃줈濡� �볥뒗�� */
...
/* ============================================================
   �� �덈ぉ �섏텧�� �숉뼢 移대뱶 �� �곗씠�� 遺꾩꽍�� 寃곌낵 �붾㈃ �먮쫫 �덉쑝濡� �댁떇
   ============================================================ */
.iti-card {
...
/* �� 臾댁뿭 �꾪솴 v2 �� �덈ぉ蹂� �꾪솴 쨌 �� �쒖옣 由ы룷�� */
.da-my-line { margin: 0 0 14px; font-size: 13px; color: var(--text-light); }
.da-my-line b { color: var(--text-dark); font-weight: 700; }
.da-items { display: flex; flex-direction: column; gap: 8px; margin: 8px 0 16px; }
.da-item {
  display: flex; align-items: center; gap: 12px;
  border: 1px solid var(--border-color); border-radius: 10px; padding: 11px 14px;
}
.da-item-main { flex: 1; min-width: 0; display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
.da-item-name { font-size: 13.5px; font-weight: 700; color: var(--text-dark); }
.da-item-hs {
  font-size: 10.5px; font-weight: 800; color: var(--primary-color);
  background: var(--primary-light); border-radius: 5px; padding: 2px 7px;
}
.da-item-meta { font-size: 12px; color: var(--text-light); }
.da-item-view {
  flex-shrink: 0; font-family: inherit; font-size: 12px; font-weight: 700;
  color: var(--primary-color); background: #fff; border: 1px solid var(--primary-color);
  border-radius: 8px; padding: 6px 11px; cursor: pointer; white-space: nowrap;
}
.da-item-view:hover { background: var(--primary-light); }
.da-markets { display: flex; flex-direction: column; gap: 8px; margin: 8px 0 16px; }
.da-market {
  border: 1px solid #d5e3f5; background: #f8fbff; border-radius: 10px; padding: 11px 14px;
}
.da-market-head { display: flex; align-items: center; justify-content: space-between; gap: 10px; flex-wrap: wrap; }
.da-market-route { font-size: 13px; font-weight: 600; color: var(--text-dark); }
.da-market-route b { font-weight: 800; }
.da-market-rank {
  font-size: 11px; font-weight: 800; color: var(--primary-color);
  background: var(--primary-light); border-radius: 999px; padding: 3px 10px; white-space: nowrap;
}
.da-market-line { margin: 5px 0 0; font-size: 12.5px; color: var(--text-light); }
.da-market-line b { color: var(--text-dark); font-weight: 700; }
.da-market-trend.up { color: var(--success-color); font-weight: 700; }
.da-market-trend.down { color: var(--error-color); font-weight: 700; }

/* ���� �꾩떆蹂닿��� (AI �듦� �묒뾽�� �섎떒 �꾩퐫�붿뼵) �������������������������������������� */
.draft-tray {
  margin-top: 32px; background: #fff; border: 1px solid #e2e8f0;
  border-radius: 16px; box-shadow: 0 1px 3px rgba(15, 23, 42, .05); overflow: hidden;
}
.draft-tray-header {
  width: 100%; display: flex; align-items: center; justify-content: space-between; gap: 14px;
  padding: 18px 24px; background: #fafbfc; border: none; cursor: pointer;
  font-family: inherit; text-align: left;
}
.draft-tray-header:hover { background: #f1f5f9; }
.draft-tray-head-main { display: flex; flex-direction: column; gap: 4px; }
.draft-tray-title { display: flex; align-items: center; gap: 10px; font-size: 17px; font-weight: 800; color: #1e293b; }
.draft-tray-count { font-size: 13px; font-weight: 700; color: #475569; background: #e2e8f0; border-radius: 999px; padding: 2px 11px; }
.draft-tray-sub { font-size: 13.5px; color: #94a3b8; }
.draft-tray-chevron { color: #94a3b8; transition: transform .18s ease; flex-shrink: 0; }
.draft-tray-chevron.open { transform: rotate(180deg); }
.draft-tray-body { padding: 16px 20px 18px; border-top: 1px solid #eef2f7; display: flex; flex-direction: column; gap: 10px; }
.draft-tray-item {
  display: flex; align-items: center; gap: 14px;
  border: 1px solid #e8edf3; border-left: 4px solid #cbd5e1; border-radius: 12px; padding: 14px 18px;
}
.draft-tray-info { min-width: 0; display: flex; flex-direction: column; gap: 5px; }
.draft-tray-line1 { display: flex; align-items: center; gap: 9px; flex-wrap: wrap; }
.draft-tray-name { font-size: 15.5px; font-weight: 700; color: #1e293b; }
.draft-tray-status { font-size: 12.5px; font-weight: 700; border-radius: 999px; padding: 3px 10px; white-space: nowrap; }
.draft-tray-route { font-size: 13.5px; color: #64748b; }
.draft-tray-time { font-size: 12.5px; color: #94a3b8; }
.draft-tray-actions { margin-left: auto; display: flex; align-items: center; gap: 8px; flex-shrink: 0; }
.draft-tray-resume {
  font-size: 13.5px; font-weight: 600; color: #334155; background: #fff;
  border: 1px solid #cbd5e1; border-radius: 9px; padding: 9px 15px; cursor: pointer;
  font-family: inherit; display: inline-flex; align-items: center; gap: 6px; white-space: nowrap;
}
.draft-tray-resume:hover { border-color: #0b57d0; color: #0b57d0; background: #f8faff; }
.draft-tray-delete {
  border: none; background: transparent; color: #cbd5e1; border-radius: 9px;
  width: 36px; height: 36px; display: inline-flex; align-items: center; justify-content: center; cursor: pointer;
}
.draft-tray-delete:hover { color: #dc2626; background: #fef2f2; }
.draft-tray-more {
  align-self: center; font-size: 13.5px; font-weight: 600; color: #475569;
  background: #fff; border: 1px solid #e2e8f0; border-radius: 9px; padding: 9px 18px;
  cursor: pointer; font-family: inherit;
}
.draft-tray-more:hover { background: #f8fafc; }
@media (max-width: 640px) {
  .draft-tray-item { flex-direction: column; align-items: stretch; gap: 10px; }
  .draft-tray-actions { margin-left: 0; justify-content: flex-end; }
}

/* ���� 理쒖쥌 �쒖텧�� 嫄곕옒 (臾몄꽌 愿�由� ��, �꾩떆蹂닿��④낵 吏� 留욎텣 移대뱶) ���������������������� */
.doc-panel {
...
.doc-panel-head:hover { background: #f1f5f9; }
.doc-panel-head-main { display: flex; flex-direction: column; gap: 4px; }
.doc-panel-title { display: flex; align-items: center; gap: 10px; font-size: 17px; font-weight: 800; color: #1e293b; }
.doc-panel-count { font-size: 13px; font-weight: 700; color: #475569; background: #e2e8f0; border-radius: 999px; padding: 2px 11px; }
.doc-panel-sub { font-size: 13.5px; color: #94a3b8; }
.doc-panel-chevron { color: #94a3b8; transition: transform .18s ease; flex-shrink: 0; }
.doc-panel-chevron.open { transform: rotate(180deg); }
.doc-panel-body { padding: 8px 20px 18px; border-top: 1px solid #eef2f7; }

.doc-empty { display: flex; flex-direction: column; align-items: center; gap: 12px; padding: 44px 24px; text-align: center; color: #94a3b8; font-size: 14px; }

/* �� �� grid 湲곕컲. 醫곸� �붾㈃�먯꽑 媛�濡� �ㅽ겕濡� */
.doc-table { display: flex; flex-direction: column; overflow-x: auto; }
.doc-table-head, .doc-table-row {
  display: grid; align-items: center;
  grid-template-columns: 1.5fr 1.7fr 0.7fr 1.2fr 0.9fr auto;
  gap: 14px; min-width: 720px;
}
.doc-table-head {
  padding: 12px 8px; font-size: 12.5px; font-weight: 700; color: #94a3b8;
  border-bottom: 1px solid #eef2f7;
}
.doc-table-row {
  padding: 16px 8px; border-bottom: 1px solid #f1f5f9;
  border-left: 3px solid #22c55e; padding-left: 14px; border-radius: 2px;
}
.doc-table-row:last-child { border-bottom: none; }
.doc-cell-name { font-size: 14.5px; font-weight: 700; color: #1e293b; }
.doc-cell-route { font-size: 13.5px; color: #475569; }
.doc-cell-incoterms { font-size: 13.5px; font-weight: 600; color: #334155; }
.doc-cell-date { font-size: 13px; color: #64748b; font-variant-numeric: tabular-nums; }
.doc-status-badge {
...
.doc-cell-actions { display: flex; align-items: center; gap: 8px; justify-content: flex-end; }
.doc-row-btn {
  font-family: inherit; font-size: 13px; font-weight: 700; white-space: nowrap;
  color: var(--primary-color); background: #fff; border: 1px solid #c7d7f0;
  border-radius: 9px; padding: 8px 13px; cursor: pointer;
}
.doc-row-btn:hover { background: #f5f8ff; }
.doc-row-btn.ghost { color: #475569; border-color: #e2e8f0; }
.doc-row-btn.ghost:hover { background: #f8fafc; }
.doc-row-del {
  border: 1px solid #e2e8f0; background: #fff; color: #94a3b8; border-radius: 9px;
  width: 34px; height: 34px; display: inline-flex; align-items: center; justify-content: center; cursor: pointer; flex-shrink: 0;
}
.doc-row-del:hover { color: #dc2626; border-color: #fecaca; background: #fef2f2; }

/* ============================================================
   �곗씠�� 遺꾩꽍 v3 �� �� 臾댁뿭 ���쒕낫�� 以묒떖 �ш뎄��
   ============================================================ */
.da-empty-my {
  background: var(--card-bg); border: 1px dashed var(--border-color); border-radius: 14px;
  padding: 26px 28px; margin-bottom: 20px; text-align: center;
}
.da-empty-my-title { font-size: 15.5px; font-weight: 800; color: var(--text-dark); margin-bottom: 6px; }
.da-empty-my p { margin: 0; font-size: 13px; color: var(--text-light); }

.da-my-tiles-big { margin-bottom: 22px; }
.da-my-tiles-big .da-my-tile { padding: 16px 18px; }
.da-my-tiles-big .da-my-tile-val { font-size: 26px; }
.da-my-tiles-big .da-my-tile-amount { font-size: 17px; }

.da-block { margin-bottom: 22px; display: flex; flex-direction: column; gap: 10px; }
.da-block:last-child { margin-bottom: 4px; }

.da-item-main { display: flex; flex-direction: column; gap: 7px; }
.da-item-top { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
.da-item-bar { display: block; height: 8px; border-radius: 999px; background: #eef2f7; overflow: hidden; }
.da-item-bar > span { display: block; height: 100%; border-radius: 999px; background: var(--primary-color); }

/* �대쾲 二� 愿��몄껌 怨좎떆�섏쑉 */
.da-rates { display: grid; grid-template-columns: repeat(auto-fit, minmax(140px, 1fr)); gap: 12px; }
.da-rate {
  background: #f8fafc; border: 1px solid var(--border-color); border-radius: 10px;
  padding: 12px 14px; display: flex; flex-direction: column; gap: 3px;
}
.da-rate-cur { font-size: 12px; font-weight: 800; color: var(--primary-color); }
.da-rate-val { font-size: 20px; font-weight: 800; color: var(--text-dark); }
.da-rate-name { font-size: 11px; color: var(--text-light); }
.da-rate-note { margin: 12px 0 0; font-size: 11.5px; color: var(--text-light); }
.da-sim-badge {
...
.upa-hint { font-size: 12px; font-weight: 600; color: var(--primary-color); }
.upa-table { width: 100%; border-collapse: collapse; font-size: 12.5px; }
.upa-table th {
  text-align: left; padding: 8px 10px; font-size: 11.5px; color: var(--text-light);
  border-bottom: 1px solid var(--border-color); white-space: nowrap;
}
.upa-table td { padding: 9px 10px; border-bottom: 1px solid #f1f5f9; color: var(--text-dark); white-space: nowrap; }
.upa-vessel { font-weight: 700; }
